import { U as Upload } from './Upload-92255bde.js';
import { M as ModifyUpload } from './ModifyUpload-6cc601f6.js';
...
import { S as SelectSource } from './SelectSource-4ad3e51e.js';
import { W as Webcam } from './ImageUploader-1dd8f65b.js';
import { p as prepare_files, u as upload, n as normalise_file } from './index-17ccf342.js';
import './Image-5e361b2a.js';
/* empty css                                                */import { l as loadFfmpeg, t as trimVideo, V as Video$2, p as prettyBytes, a as playable } from './Video-c60e968e.js';
export { b as loaded } from './Video-c60e968e.js';
...
import { D as DownloadLink } from './DownloadLink-7d20f887.js';
export { default as BaseExample } from './Example-5f6b8d70.js';
import { U as UploadText } from './UploadText-8aa4a29d.js';
...
// (44:1) {#if value === null || value.url === undefined}
...
function create_if_block_2$1(ctx) {
	...
	webcam.$on("error", /*error_handler*/ ctx[21]);
	webcam.$on("capture", /*handle_capture*/ ctx[17]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*root*/ 512) webcam_changes.root = /*root*/ ctx[9];
...
function create_if_block_1$1(ctx) {
	...
	function upload_dragging_binding(value) {
		/*upload_dragging_binding*/ ctx[19](value);
	}
	...
	upload.$on("error", /*error_handler_1*/ ctx[20]);
...
// (47:4) <Upload      bind:dragging      filetype="video/x-m4v,video/*"      on:load={handle_load}      on:error={({ detail }) => dispatch("error", detail)}      {root}     >
...
//# sourceMappingURL=index-1af3fc24.js.map
