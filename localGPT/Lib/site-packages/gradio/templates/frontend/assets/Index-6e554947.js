import { B as Block } from './Button-bca2b91e.js';
import { S as Static } from './Index-927dbe6c.js';
import { B as BlockLabel } from './BlockLabel-6746a7d7.js';
import { I as IconButton } from './IconButton-5bbf3ac8.js';
import { E as Empty } from './Empty-a901bb0d.js';
import { S as ShareButton } from './ShareButton-5fd0b17f.js';
import { D as Download } from './Download-ea83bae3.js';
import { I as Image } from './Image-6cbf81d1.js';
import { n as normalise_file } from './index-17ccf342.js';
/* empty css                                                     */import { M as ModifyUpload } from './ModifyUpload-6cc601f6.js';
import { I as Image$1 } from './Image-5e361b2a.js';
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "grid-container svelte-33qalu");
			...
			attr(div1, "class", "grid-wrap svelte-33qalu");
...
// (173:0) {#if value == null || resolved_value == null || resolved_value.length === 0}
...
// (176:1) {#if selected_image && allow_preview}
function create_if_block_3(ctx) {
	...
	modifyupload.$on("clear", /*clear_handler*/ ctx[29]);

	image_1 = new Image$1({
			props: {
				"data-testid": "detailed-image",
				src: /*selected_image*/ ctx[17].image.url,
				alt: /*selected_image*/ ctx[17].caption || "",
				title: /*selected_image*/ ctx[17].caption || null,
				class: /*selected_image*/ ctx[17].caption && "with-caption",
				loading: "lazy"
			}
		});
	...
	return {
		c() {
			...
			attr(div0, "class", "icon-buttons svelte-33qalu");
			attr(button0, "class", "image-button svelte-33qalu");
			...
			attr(div1, "class", "thumbnails scroll-hide svelte-33qalu");
			attr(div1, "data-testid", "container_el");
			attr(button1, "class", "preview svelte-33qalu");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(button0, "click", /*click_handler_1*/ ctx[30]),
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*selected_image*/ 131072) image_1_changes.src = /*selected_image*/ ctx[17].image.url;
			if (dirty[0] & /*selected_image*/ 131072) image_1_changes.alt = /*selected_image*/ ctx[17].caption || "";
			if (dirty[0] & /*selected_image*/ 131072) image_1_changes.title = /*selected_image*/ ctx[17].caption || null;
			if (dirty[0] & /*selected_image*/ 131072) image_1_changes.class = /*selected_image*/ ctx[17].caption && "with-caption";
...
function create_if_block_5(ctx) {
	...
	iconbutton.$on("click", /*click_handler*/ ctx[28]);

	return {
		c() {
			div = element("div");
			create_component$1(iconbutton.$$.fragment);
			attr(div, "class", "download-button-container svelte-33qalu");
		},
		m(target, anchor) {
...
// (219:3) {#if selected_image?.caption}
function create_if_block_4(ctx) {
	...
	return {
		c() {
			...
			t = text(t_value);
			attr(caption, "class", "caption svelte-33qalu");
		},
		m(target, anchor) {
...
// (229:4) {#each resolved_value as image, i}
function create_each_block_1(ctx) {
	...
	const assign_button = () => /*button_binding*/ ctx[31](button, i);
	const unassign_button = () => /*button_binding*/ ctx[31](null, i);

	function click_handler_2() {
		return /*click_handler_2*/ ctx[32](/*i*/ ctx[45]);
	}
	...
	return {
		c() {
			...
			create_component$1(image_1.$$.fragment);
			t = space$1();
			attr(button, "class", "thumbnail-item thumbnail-small svelte-33qalu");
			attr(button, "aria-label", button_aria_label_value = "Thumbnail " + (/*i*/ ctx[45] + 1) + " of " + /*resolved_value*/ ctx[12].length);
			toggle_class(button, "selected", /*selected_index*/ ctx[0] === /*i*/ ctx[45]);
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const image_1_changes = {};
			if (dirty[0] & /*resolved_value*/ 4096) image_1_changes.src = /*image*/ ctx[46].image.url;
			if (dirty[0] & /*resolved_value*/ 4096) image_1_changes.title = /*image*/ ctx[46].caption || null;
			image_1.$set(image_1_changes);

			if (!current || dirty[0] & /*resolved_value*/ 4096 && button_aria_label_value !== (button_aria_label_value = "Thumbnail " + (/*i*/ ctx[45] + 1) + " of " + /*resolved_value*/ ctx[12].length)) {
			...
			if (!current || dirty[0] & /*selected_index*/ 1) {
				toggle_class(button, "selected", /*selected_index*/ ctx[0] === /*i*/ ctx[45]);
			}
		},
		i(local) {
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "icon-button svelte-33qalu");
		},
		m(target, anchor) {
			insert$1(target, div, anchor);
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text(t_value);
			attr(div, "class", "caption-label svelte-33qalu");
		},
		m(target, anchor) {
			insert$1(target, div, anchor);
			append(div, t);
		...
		p(ctx, dirty) {
			if (dirty[0] & /*resolved_value*/ 4096 && t_value !== (t_value = /*entry*/ ctx[43].caption + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) {
				detach$1(div);
...
// (271:3) {#each resolved_value as entry, i}
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			t1 = space$1();
			attr(button, "class", "thumbnail-item thumbnail-lg svelte-33qalu");
			attr(button, "aria-label", button_aria_label_value = "Thumbnail " + (/*i*/ ctx[45] + 1) + " of " + /*resolved_value*/ ctx[12].length);
			toggle_class(button, "selected", /*selected_index*/ ctx[0] === /*i*/ ctx[45]);
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const image_1_changes = {};
			if (dirty[0] & /*resolved_value*/ 4096) image_1_changes.alt = /*entry*/ ctx[43].caption || "";

			if (dirty[0] & /*resolved_value*/ 4096) image_1_changes.src = typeof /*entry*/ ctx[43].image === "string"
			? /*entry*/ ctx[43].image
			: /*entry*/ ctx[43].image.url;
...
// (174:1) <Empty unpadded_box={true} size="large">
...
function create_fragment$1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(window_1, "resize", /*onwindowresize*/ ctx[27]);
				mounted = true;
			}
		},
		p(ctx, dirty) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('root' in $$props) $$invalidate(21, root = $$props.root);
		if ('proxy_url' in $$props) $$invalidate(22, proxy_url = $$props.proxy_url);
		if ('value' in $$props) $$invalidate(3, value = $$props.value);
		if ('columns' in $$props) $$invalidate(4, columns = $$props.columns);
		if ('rows' in $$props) $$invalidate(5, rows = $$props.rows);
		if ('height' in $$props) $$invalidate(6, height = $$props.height);
		if ('preview' in $$props) $$invalidate(23, preview = $$props.preview);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*value, was_reset*/ 16777224) {
			$$invalidate(24, was_reset = value == null || value.length === 0 ? true : was_reset);
		}

		if ($$self.$$.dirty[0] & /*value, root, proxy_url*/ 6291464) {
		...
		if ($$self.$$.dirty[0] & /*prev_value, value, was_reset, preview, selected_index*/ 58720265) {
			if (!dequal(prev_value, value)) {
				// When value is falsy (clear button or first load),
				// preview determines the selected image
				if (was_reset) {
					$$invalidate(0, selected_index = preview && value?.length ? 0 : null);
					$$invalidate(24, was_reset = false);
				...
				dispatch("change");
				$$invalidate(25, prev_value = value);
			}
		}
		...
		if ($$self.$$.dirty[0] & /*selected_index, old_selected_index, resolved_value*/ 67112961) {
			{
...
//# sourceMappingURL=Index-6e554947.js.map
